...
public interface LiveRoomMemberDao extends IMongoDAO<LiveRoom.LiveRoomMember, ObjectId> {
    ...
    List<LiveRoom.LiveRoomMember> getLiveRoomMemberList(ObjectId roomId, int online, Integer pageIndex, Integer pageSize);

    void addMemberRewardCount(ObjectId roomId, int userId, double rewardCount);

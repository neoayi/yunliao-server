...
StringUtil {
	...
	public static String randomFileName(String fileName) {
		return randomUUID() + "." + getFormatName(fileName);
	}
	...
	public static String getIntegerByList(List<Integer> ints, String sep) {
		StringBuffer sb = new StringBuffer();
		sb.append(ints.get(0));
		for (int i = 1; i < ints.size(); i++) {
			sb.append(sep).append(ints.get(i));
	...
	**/ 
	 ...
	 * @return
	 */
	public static boolean contain2(String source, String keyword) {

package com.basic.im.friends.entity;
...
public class Friends {
	...
	private Integer status;// 状态（1=关注；2=好友；-1=黑名单）
	...
	/**
	 * 隐藏好友会话 0：关闭 1开启 默认值 0
	 */
	private byte hideChatSwitch=KConstants.ZERO;
	...
	public Friends(int userId, int toUserId,String toNickname, Integer status, Integer blacklist,Integer isBeenBlack,double chatRecordTimeOut) {
		super();
		this.userId = userId;
		this.toUserId = toUserId;
		this.toNickname=toNickname;
	...
	public void setHideChatSwitch(byte hideChatSwitch) {
		this.hideChatSwitch = hideChatSwitch;
	}

	public byte getHideChatSwitch() {
		return hideChatSwitch;
	}

package com.basic.im.redpack.dao.impl;
...
public class RedPacketDaoImpl extends BaseMongoRepository<RedPacket, ObjectId> implements RedPacketDao {
    ...
    @Override
    public PageResult<RedPacket> getRedPackListPageResult(String userName, String redPacketId, int pageIndex, int pageSize,Integer status) {

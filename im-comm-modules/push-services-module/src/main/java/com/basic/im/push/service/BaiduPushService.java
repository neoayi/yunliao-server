...
import com.basic.utils.FileUtil;
...
/*	public static final String APPSTORE_APPID=pushConfig.getBd_appStore_appId();
	                                             
	public static final String APPSTORE_APPKEY=pushConfig.getBd_appStore_appKey();
	                                                
	public static final String APPSTORE_SECRET_KEY=pushConfig.getBd_appStore_secret_key();
	
	// EMPTY，安卓，iOS
	public static final String[] APP_KEY = (String[]) pushConfig.getBd_appKey();
	public static final String REST_URL = pushConfig.getBd_rest_url();
	public static final String[] SECRET_KEY = (String[]) pushConfig.getBd_secret_key();*/

	private static byte[] getBytes(Map<String, Object> params) throws Exception {
		StringBuffer sb = new StringBuffer();

		for (Map.Entry<String, Object> entry : params.entrySet()) {
			sb.append(entry.getKey()).append('=').append(null!=entry.getValue()?entry.getValue().toString():"").append('&');
		}

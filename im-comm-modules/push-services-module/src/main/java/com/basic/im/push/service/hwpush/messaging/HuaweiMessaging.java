 ...
 *
 * <p>You can get a instance of
 * by a instance of and then use it to send a message
 */
public class HuaweiMessaging {
    ...
    public SendResponse sendMessage(Message message, boolean validateOnly) throws HuaweiMesssagingException {
        ...
        final HuaweiMessageClient messagingClient = getMessagingClient();
        return messagingClient.send(message, validateOnly, ImplHuaweiTrampolines.getAccessToken(app), ImplHuaweiTrampolines.getPackName(app));
    }

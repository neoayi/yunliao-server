...
public final class ImplHuaweiTrampolines {
    ...
    // 自定义
    public static String getPushUrl(HuaweiApp app) {
        return app.getOption().getCredential().getPushUrl();
    }
    public static String getPackName(HuaweiApp app) {
        return app.getOption().getCredential().getPackageName();
    }

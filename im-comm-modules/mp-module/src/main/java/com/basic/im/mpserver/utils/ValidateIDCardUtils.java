...
//    }
    ...
    public static boolean validateTWCard(String idCard) {
        ...
        return (sum % 10 == 0 ? 0 : (10 - sum % 10)) == Integer.parseInt(end) ? true
                : false;
    }
...
//    }
    ...
    public static String getConstellationById(String idCard) {
        ...
        int month = ValidateIDCardUtils.getMonthByIdCard(idCard);
        int day = ValidateIDCardUtils.getDateByIdCard(idCard);
        String strValue = "";
    ...
    public static String getZodiacById(String idCard) { // 根据身份证号，自动返回对应的生肖
        ...
        int year = ValidateIDCardUtils.getYearByIdCard(idCard);
        int end = 3;
        int x = (year - end) % 12;
    ...
    public boolean checkIdCard(String idCard) {
        ...
        System.out.println(ValidateIDCardUtils.getGenderByIdCard(idCard));
        System.out.println(ValidateIDCardUtils.getBirthByIdCard(idCard));
        System.out.println(ValidateIDCardUtils.getMonthByIdCard(idCard));
        System.out.println(ValidateIDCardUtils.getDateByIdCard(idCard));
        System.out.println(ValidateIDCardUtils.getConstellationById(idCard));
        System.out.println(ValidateIDCardUtils.getZodiacById(idCard));
        System.out.println(ValidateIDCardUtils.getChineseEraById(idCard));
        System.out.println(ValidateIDCardUtils.getProvinceByIdCard(idCard));

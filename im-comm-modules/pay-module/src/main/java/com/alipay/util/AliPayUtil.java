...
import com.basic.im.comm.utils.JSONUtil;
import com.basic.im.pay.model.AliPayConfig;
...
public class AliPayUtil {
	...
	static AliPayConfig aliPayConfig=null;

	public static void setAppConfig(AliPayConfig config){
...
//			model.setGoodsType("0");
			...
			try {
				//log.info("当前配置:{}" + JSON.toJSONString(aliPayConfig));
				log.info("当前appId:" + APP_ID);
				log.info("当前回调:" + callBackUrl);

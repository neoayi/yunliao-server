...
public interface UserCoreDao extends IMongoDAO<User,Integer> {
    ...
    List<Integer> quseryUserIdListByAccount(String account);

    List<Integer> quseryUserIdListByAccount(List<Integer> userIds, String account);
    ...
    List<Integer> queryDefFriendUserIdList(List<String> defPhoneList);

    List<User> findByIds(List<Integer> userIds);
    List<User> findByIds(List<Integer> userIds,Integer pageIndex,Integer pageSize);

    List<User> findByNotInIds(List<Integer> userIds, int pageIndex, int pageSize);
}

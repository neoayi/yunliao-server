...
layui.use(['form','layer','laydate','table','laytpl','element'],function(){
    ...
    var tableIns = table.render({
      ...
      ,groups: 7
      ,cols: [[ //表头
           {field: 'name', title: '音乐名称',width:'12%'}
          ,{field: 'nikeName', title: '创作人',width:'12%'}
          ,{field: 'cover', title: '封面图地址', width:'22%'}
          ,{field: 'path', title: '音乐地址', width:'22%'}
          ,{field: 'length', title: '音乐长度', width:'12%'}
          ,{field: 'useCount', title: '使用数量', width:'12%'}
          ,{fixed: 'right',title:"操作", align:'left', toolbar: '#musicListBar'}
        ]]
...
var Music={
	...
	deleteMusic:function(id){
		layer.confirm('确定删除该音乐？',{icon:3, title:'提示信息',skin : "layui-ext-motif"},function(index){
			Common.invoke({

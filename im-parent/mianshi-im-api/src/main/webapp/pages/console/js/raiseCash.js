...
layui.use(['form','layer','laydate','table','laytpl'],function(){
    ...
    var tableIns = table.render({
        ...
        ,totalRow: true
        ,cols: [[ //表头
            {field: 'id', title: '提现记录Id',width:150, totalRowText: '合计'}
            ,{field: 'tradeNo', title: '交易单号',width:180}
            ,{field: 'userId', title: '用户Id', width:120}
            ,{field: 'userName', title: '提现用户昵称', width:120}
            ,{field: 'money', title: '提现金额', width:120, totalRow: true}
            ,{field: 'serviceCharge', title: '手续费', width:120, totalRow: true}
            ,{field: 'operationAmount', title: '实际金额', width:120, totalRow: true}
            ,{field: 'currentBalance', title: '账户余额', width:120, totalRow: true}
            ...
            ,{field: 'type', title: '类型', width:150, templet : function (d) {
					var statusMsg;
            		(d.type == 1 ? statusMsg = "APP充值" : (d.type == 2) ? statusMsg = "用户提现" : (d.type == 16) ? statusMsg = "后台手工提现" : (d.type == 19) ? statusMsg = "扫码手动提现" : statusMsg = "其他方式充值")
					return statusMsg;
                }}

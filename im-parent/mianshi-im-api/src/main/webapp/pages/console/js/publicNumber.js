    ...
    var tableIns = table.render({
      ...
      ,cols: [[ //表头
        ...
        ,done:function(res){
            ...
            //权限判断
            var arr=['pub-delete','pub-randUser','supperAdmin'];
    ...
    table.on('tool(admin_list)', function(obj){
        ...
        if(layEvent === 'delete'){ //删除
          ...
          if(data.userId <= 10000)
                return;
         	layer.confirm('确定删除该公众号？',{icon:3, title:'提示信息',skin : "layui-ext-motif"},function(index){
                Common.invoke({
            ...
            localStorage.setItem("start_page","/pages/console/publicNumber.html");

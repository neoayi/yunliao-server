...
layui.use(['form','layer','laydate','table','laytpl'],function(){
    ...
    var tableIns = table.render({
      ...
      ,cols: [[ //表头
        ...
        ,done:function(res){
            ...
            //权限判断
            var arr=['admin-delete','admin-randUser','admin-locking','admin-resource','admin-add','supperAdmin'];
    ...
    table.on('tool(admin_list)', function(obj){
        ...
        if(layEvent === 'delete'){ //删除
         	...
         	layer.confirm('确定删除该管理员？',{icon:3, title:'提示信息',skin : "layui-ext-motif"},function(index){
            ...
            localStorage.setItem("start_page","/pages/console/admin.html");

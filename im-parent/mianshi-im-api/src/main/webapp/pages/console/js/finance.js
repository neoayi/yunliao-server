...
layui.use(['form', 'layer', 'laydate', 'table', 'laytpl'], function () {
    ...
    var tableIns = table.render({
        ...
        ,
            ...
            //权限判断
            var arr = ['fin-delete', 'fin-randUser', 'fin-locking', 'fin-resource', 'fin-add', 'supperAdmin', 'fin-add'];
            manage.authButton(arr);

            //获取零时保留的值
            var last_value = $("#finance_limlt").val();
            //获取当前每页大小
            var recodeLimit = tableIns.config.limit;
            //设置零时保留的值
            $("#finance_limlt").val(recodeLimit);
            //判断是否改变了每页大小数
    ...
    table.on('tool(admin_list)', function (obj) {
        ...
        if (layEvent === 'delete') { //删除
            ...
            layer.confirm('确定删除该财务？', {icon: 3, title: '提示信息', skin: "layui-ext-motif"}, function (index) {
            ...
            localStorage.setItem("start_page", "/pages/console/finance.html");

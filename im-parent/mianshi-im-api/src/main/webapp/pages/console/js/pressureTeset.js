...
layui.use(['form','layer','laydate','table','laytpl'],function(){
    ...
    $(".search_live").on("click",function(){
            ...
            table.reload("room_table",{
                ...
                where: {
                    keyWorld : Common.getValueForElement("#roomName")  //搜索的关键字
                }
            })
        $("#roomName").val("");
    ...
    $(".sendMsg").on("click",function(){
        ...
        Common.invoke({
            ...
            data : {
                "checkNum" : Common.getValueForElement(".sendPeopleNum"),
                "sendMsgNum" : Common.getValueForElement(".sendTotal"),
                "roomJid":arr.join(","),
                "timeInterval": Common.getValueForElement(".timeInterval")
            },

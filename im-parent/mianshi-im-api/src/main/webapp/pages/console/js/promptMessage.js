...
layui.use(['form', 'layer', 'laydate', 'table', 'laytpl'], function () {
    ...
    var hintInfoTableIns = table.render({
        ...
        , cols: [[ //表头
            ...
            , {field: 'zh', title: '中文', width: '15%'}
            , {field: 'en', title: '英文', width: '15%'}
            , {field: 'big5', title: '繁体', width: '15%'}
            , {fixed: 'right',width:200, title: "操作", align: 'left', toolbar: '#hitiInfoListBar'}
        ]]
        , done: function (res) {
            //权限判断
            var arr = ['hitiInfo-delete', 'hitiInfo-update', 'hitiInfo-add'];
    ...
    table.on('tool(hitiInfoList_table)', function (obj) {
        ...
        if (layEvent === 'delete') { //删除
            ...
            layer.confirm('确定删除该提示消息？',{icon:3, title:'提示信息',skin : "layui-ext-motif"},function(index){
                Common.invoke({
                    type: "POST",

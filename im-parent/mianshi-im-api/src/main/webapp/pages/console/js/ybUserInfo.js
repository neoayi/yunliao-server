layui.use(['form','layer','laydate','table','laytpl'],function() {
    ...
    var tableIns = table.render({
        ...
        , groups: 7
        , cols: [[ //表头
            // {field: 'id', title: '账户信息Id',  width: 180}
            {field: 'userId', title: 'userId', width: 120}
            , {field: 'openAccountName', title: '开户真实姓名', width: 150}
            , {field: 'openAccountCardNo', title: '开户身份证号', width: 180}
            , {field: 'openAccountTelephone', title: '开户填写手机号', width: 160}
            , {field: 'walletUserNo', title: '用户钱包账户ID', width: 150}
            , {field: 'walletCategory', title: '账户钱包等级', width: 150}
            , {field: 'status', title: '账户状态', width: 120,templet:function (d) {
...
var YopUser = {
    deleteYopUserInfo:function (id) {
        layer.confirm('确定删除该钱包账户信息？',{icon:3,skin : "layui-ext-motif", title:'提示信息'},function(index){
            Common.invoke({
    ...
    freezeYopUser:function (id,status) {
        layer.confirm('确定冻结该账户？',{icon:3,skin : "layui-ext-motif", title:'提示信息'},function(index){
            Common.invoke({
    ...
    unfreezeYopUser:function (id,status) {
        layer.confirm('确定解冻账户？',{icon:3,skin : "layui-ext-motif", title:'提示信息'},function(index){
            Common.invoke({
                url:request("/console/yopUserInfo/freeze"),
                data:{
                    id:id,
    ...
    goYopUserBill:function (userId) {
        ...
        var tableIns = layui.table.render({
            ...
            , groups: 7
            , cols: [[ //表头
                {field: 'id', title: '记录Id',width:150}
                ,{field: 'businessNo', title: '云钱包交易单号',width:180}
                ,{field: 'requestNo', title: '商户请求号',width:180}
                ...
                ,{field: 'operationAmount', title: '交易金额', width:120}
                ,{field: 'payType', title: '支付方式', width:120,templet : function (d) {return "云钱包支付";}}
                ,{field: 'orderStatus', title: '交易状态', width:120}

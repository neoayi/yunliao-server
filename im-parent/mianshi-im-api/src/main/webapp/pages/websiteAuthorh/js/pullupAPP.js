/*var browser = {
    ...
    var downLoad ={
        ...
        versions : function () {
            let testUrl = encodeURIComponent(requestData.callbackUrl);
            // 客户端校验给一个授权回调域名
            if (navigator.userAgent.match(/android/i)) {
                var flag = false;
                var openApp = window.open("chatimapp://www.chatandroid.com:80/?appId="+requestData.appId+"&callbackUrl="+testUrl);
                // var openApp = window.open("chatimapp://www.chatandroid.com:80/?appId="+requestData.appId+"&redirectURL="+requestData.callbackUrl);
                ...
                window.setTimeout(function () {
                    if(!flag){
                        window.location.href = "https://www.pgyer.com/chat2";// 下载地址
                    }
            ...
            if (navigator.userAgent.match(/(iPhone|iPod|iPad);?/i)) {
              /*  $('.modal-body').html("数据："+requestData.appId+requestData.callbackUrl);
                ...
                window.open("chatimapp://www.chatios.com:80/?appId="+requestData.appId+"&callbackUrl="+testUrl);//ios app协议
                window.setTimeout(function () {

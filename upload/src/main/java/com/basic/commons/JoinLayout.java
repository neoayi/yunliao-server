...
public class JoinLayout {
    ...
    private static float[] offset5(int index, float dimension, float[] size) {
        ...
        //上下
        float xx1 = (dimension - cd - y3 - s1) / 2.0F+18;
        //左右
        float xxc1 = (dimension - cd) / 2.0F+24;
        switch (index) {
            case 0:
    ...
    private static float[] offset5_new(int index, float dimension, float[] size) {
        float cd = dimension * size[0];
        float s1 = -cd * size[1];
        float x1 = 0.0F;
        float x2 = (float) ((double) s1 * Math.cos(0.3316125578789226D))+35;

        float y2 = (float) ((double) s1 * Math.sin(0.3141592653589793D));

        float x3 = (float) ((double) s1 * Math.cos(0.9424777960769379D))+25;


        float y3 = (float) ((double) (-s1) * Math.sin(0.9424777960769379D))-25;


        float x4 = (float) ((double) (-s1) * Math.cos(0.9424777960769379D))-15;

        float y4 = (float) ((double) (-s1) * Math.sin(0.9424777960769379D))-25;

        float x5 = (float) ((double) (-s1) * Math.cos(0.3316125578789226D))-25;

        float y5 = (float) ((double) s1 * Math.sin(0.3141592653589793D));

        float xx1 = (dimension - cd - y3 - s1) / 2.0F+15;
        float xxc1 = (dimension - cd) / 2.0F+15;
        switch (index) {
            case 0:
                return new float[]{x1 + xxc1, s1 + xx1};
            case 1:
    ...
    private static float[] offset4(int index, float dimension, float[] size) {
        ...
        float x1 = 0.0F;
        float y1 = 0.0F;
        float xx1 = (dimension - cd - s1) / 2.0F+33-10;
        switch (index) {
            case 0:
    ...
    private static float[] offset3(int index, float dimension, float[] size) {
        ...
        float x3 = s1 * 2.0F - x2;
        float xx1 = (dimension - cd - y2) / 2.0F+30-10;
        float xxc1 = (dimension - cd) / 2.0F - s1+30-10;
        switch (index) {
            case 0:
    ...
    private static float[] offset2(int index, float dimension, float[] size) {
        ...
        float x1 = 0.0F;
        float y1 = 0.0F;
        float xx1 = (dimension - cd - s1) / 2.0F+10;
        switch (index) {
            case 0:
                return new float[]{x1 + xx1, y1 + xx1};
            case 1:
    ...
    private static float[] offset1(int index, float dimension, float[] size) {
        float cd = dimension * size[0];
        float offset = (dimension - cd) / 2.0F-80;
        return new float[]{offset+100, offset+100};
    }
}

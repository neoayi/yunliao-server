...
import com.basic.mongodb.exception.LambdaWrapperExpression;
...
public class SerializedLambda implements Serializable {
    ...
    public static SerializedLambda resolve(SFunction<?, ?> lambda) {
        if (!lambda.getClass().isSynthetic()) {
            throw new LambdaWrapperExpression("This method can only pass in synthetic classes produced by lambda expressions");
        }
        try (ObjectInputStream objIn = new ObjectInputStream(new ByteArrayInputStream(SerializationUtils.serialize(lambda))) {
            ...
            throw new LambdaWrapperExpression("This is impossible to happen");
        }
    }
    ...
    public Class getInstantiatedMethodType() {
        ...
        throw new LambdaWrapperExpression(String.format("Unable to resolve call instance from %s...",matcher));
    }

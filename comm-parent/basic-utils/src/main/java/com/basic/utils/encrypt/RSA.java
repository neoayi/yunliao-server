...
public class RSA {
    ...
    public static Map<String, String> generateKeyPair() throws Exception {
        ...
        String pub = new String(org.apache.commons.codec.binary.Base64.encodeBase64(publicKeyBytes),
                CHAR_ENCODING);
        /** 得到私钥 */
        Key privateKey = kp.getPrivate();
        byte[] privateKeyBytes = privateKey.getEncoded();
        String pri = new String(org.apache.commons.codec.binary.Base64.encodeBase64(privateKeyBytes),
                CHAR_ENCODING);
    ...
    public static Map<String, String> generateKeyPair(int size) throws Exception {
        /** RSA算法要求有一个可信任的随机数源 */
        SecureRandom sr = new SecureRandom();
        /** 为RSA算法创建一个KeyPairGenerator对象 */
        KeyPairGenerator kpg = KeyPairGenerator.getInstance("RSA");

...
public class StaticWordFilter {
    ...
    private static List<String> readWordFromFile(String path) {
        ...
        try {
            br = new BufferedReader(new InputStreamReader(StaticWordFilter.class.getClassLoader().getResourceAsStream(path)));
     ...
     * @param words
     */
    private static void addStopWord(final Collection<String> words) {
        if (!isEmpty(words)) {
            char[] chs;
     ...
     * @param words
     */
    private static void addSensitiveWord(final Collection<String> words) {
        if (!isEmpty(words)) {
            char[] chs;
            int fchar;
            int lastIndex;

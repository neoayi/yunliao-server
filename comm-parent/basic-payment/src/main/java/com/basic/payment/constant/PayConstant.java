package com.basic.payment.constant;
...
public class PayConstant {
	 ...
	 * 支付方式启用
	 */
	public final static byte PAY_CHANNEL_ENABLE=1;
	/**
	 * 支付方式停用
	 */
	public final static byte PAY_CHANNEL_DISABLE=0;
	...
	public final static String PAY_CHANNEL_ALIPAY ="ALIPAY";
	...
	public final static byte PAY_STATUS_CANCEL = -3;
	// 订单过期
	 ...
	 *
	 */
	public final static byte PAY_STATUS_REFUND = -4;



	public final static int ERROR_ORDER_NOTEXIST = 2000;
	/**
	 * 订单过期
	 */
	public final static int ERROR_STATUS_EXPIRED = 2001;
	// 支付失败
	public final static int ERROR_STATUS_FAILED = 2002;
	public final static int ERROR_STATUS_PAYING = 2003;
	public final static int ERROR_STATUS_SUCCESS = 2004;
	/**
	 * 订单已取消
	 */
	public final static int ERROR_STATUS_CANCEL = 2005;

	/**
	 * 订单已退款
	 */
	public final static int ERROR_STATUS_REFUND = 2006;


	/**
	 * 支付方式不支持
	 */
	public final static int ERROR_PAY_CHANNEL_DISABLE = 2010;

	public final static int ERROR_PAY_CHANNEL_REQEST = 2020;
